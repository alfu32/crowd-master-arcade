...
- Key names: field names before `:`, including `name`, `road_length`, `road_width`, `starting_soldiers`, `fire_rate`, `max_fire_rate`, `projectile_pool`, `projectile_length`, `soldier_model`, `boss_model`, `manpower_card_model`, `firepower_card_model`, `bulletpower_card_model`, `soldierlife_card_model`, `bulletrange_card_model`, `player_color`, `enemy_color`, `boss_color`, `decoration_color`, `op`, `param`, `val`, `x`, `z`, `model`, `color`, `power`, `effective`, and `strength`.
